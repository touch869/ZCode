...
// 遥测已全部移除（P1）：ZCODE_TELEMETRY_ENABLED / ZCODE_TELEMETRY_REPORT_ENDPOINT /
// ZCODE_ARMS_RUM_ENDPOINT / mapZCodeEnvToArmsRumEnv / ArmsRumEnv 均已删除。
// 本文件只保留产品身份与环境判定（ZCODE_ENV、ZCODE_PRODUCT_FLAVOR）——
// 它们被 35 / 12 个源文件引用，与遥测无关。
